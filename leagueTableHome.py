...
def main(context):
    ...
    #                                os.environ['LEAGUE_TABLE_HOME_EPL23_24'],
    #                                os.environ['LEAGUE_TABLE_HOME_EPL24_25'],
    #                                os.environ['LEAGUE_TABLE_HOME_PSL20_21'],
    #                                os.environ['LEAGUE_TABLE_HOME_PSL21_22'],
    #                                os.environ['LEAGUE_TABLE_HOME_PSL22_23'],
    #                                os.environ['LEAGUE_TABLE_HOME_PSL23_24'],
    #                                os.environ['LEAGUE_TABLE_HOME_PSL24_25']]
        ...
        if leagueTable_data and 'data' in leagueTable_data:
            ...
            try:
                ...
                if (attList['total'] == 0):
                    ...
                    context.log('Initial Attributes added for '+ LEAGUE_TABLE_HOME_collection_id[i])
                ...
                context.log('Check attributes for '+ str(LEAGUE_TABLE_HOME_collection_id[i]))

...
LEAGUE_TABLE_HOME_collection_id = [os.getenv('LEAGUE_TABLE_HOME_EPL24_25'), os.getenv('LEAGUE_TABLE_HOME_PSL24_25')]
# LEAGUE_TABLE_HOME_collection_id = [os.getenv('LEAGUE_TABLE_HOME_EPL20_21'),
#                                os.getenv('LEAGUE_TABLE_HOME_EPL21_22'),
#                                os.getenv('LEAGUE_TABLE_HOME_EPL22_23'),
#                                os.getenv('LEAGUE_TABLE_HOME_EPL23_24'),
#                                os.getenv('LEAGUE_TABLE_HOME_EPL24_25'),
#                                os.getenv('LEAGUE_TABLE_HOME_PSL20_21'),
#                                os.getenv('LEAGUE_TABLE_HOME_PSL21_22'),
#                                os.getenv('LEAGUE_TABLE_HOME_PSL22_23'),
#                                os.getenv('LEAGUE_TABLE_HOME_PSL23_24'),
#                                os.getenv('LEAGUE_TABLE_HOME_PSL24_25')]
...
for i in range(0,count):
    ...
    if leagueTable_data and 'data' in leagueTable_data:
        ...
        leagueTableDataDF = convert_json_to_df(leagueTable_data['data']['all_matches_table_home'])
        leagueTableDataJSON=prepare_for_appwrite(leagueTableDataDF)

        docIDs = get_all_document_ids(database_id, LEAGUE_TABLE_HOME_collection_id[i])
        classifications=group_columns(leagueTable_data['data']['all_matches_table_home'])

        try:
            attList = databases.list_attributes(
            database_id = database_id,
            collection_id= LEAGUE_TABLE_HOME_collection_id[i]
            )

            attr_categories = get_categorized_attributes(database_id, LEAGUE_TABLE_HOME_collection_id[i])
            ...
            if (attList['total'] == 0):
                ...
                print('Initial Attributes added for '+ LEAGUE_TABLE_HOME_collection_id[i])
            ...
            print('Check attributes for '+ str(LEAGUE_TABLE_HOME_collection_id[i]))

...
def main(context):
    ...
    over_collection_id = os.environ['OVER_LIST_COLLECTION_ID']
        ...
        if over25_data and 'data' in over25_data:
            ...
            try:
                ...
                if (attList['total'] == 0):
                    ...
                    context.log('Initial Attributes added for '+ over_collection_id)
                ...
                context.log('Check attributes for '+ str(over_collection_id))
            ...
            for over25Fixture in over25DataJSON:
                ...
                try:
                    ...
                    context.log('Documents created for '+over25Fixture['id'])
                except Exception as e:
                    ...
                    if field_name and field_name in over25Fixture:
                        ...
                        context.log(f"{field_name} type: {type(over25Fixture[field_name])}")
                        context.log(f"{field_name} length: {len(str(over25Fixture[field_name]))}")
                        context.log(f"Preview: {str(over25Fixture[field_name])[:100]}...")

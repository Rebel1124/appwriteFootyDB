...
# currSeasonID=['4912', '6089', '7593', '9663', '12451', '5302', '6308', '8241', '10465', '13303']
...
playerStats_collection_id = [os.getenv('PLAYER_STATS_ECH24_25')]
# playerStats_collection_id = [os.getenv('PLAYER_STATS_ECH24_25'), os.getenv('PLAYER_STATS_NFD24_25')]
# playerStats_collection_id = [os.getenv('PLAYER_STATS_ECH20_21'),
#                                os.getenv('PLAYER_STATS_ECH21_22'),
#                                os.getenv('PLAYER_STATS_ECH22_23'),
#                                os.getenv('PLAYER_STATS_ECH23_24'),
#                                os.getenv('PLAYER_STATS_ECH24_25'),
#                                os.getenv('PLAYER_STATS_NFD20_21'),
#                                os.getenv('PLAYER_STATS_NFD21_22'),
#                                os.getenv('PLAYER_STATS_NFD22_23'),
#                                os.getenv('PLAYER_STATS_NFD23_24'),
#                                os.getenv('PLAYER_STATS_NFD24_25')]

...
def main(context):
    ...
    playerStats_collection_id = [os.environ('PLAYER_STATS_NFD24_25')]
    # playerStats_collection_id = [os.environ('PLAYER_STATS_ECH24_25'), os.environ('PLAYER_STATS_NFD24_25')]
    # playerStats_collection_id = [os.environ('PLAYER_STATS_ECH20_21'),
    #                                os.environ('PLAYER_STATS_ECH21_22'),
    #                                os.environ('PLAYER_STATS_ECH22_23'),
    #                                os.environ('PLAYER_STATS_ECH23_24'),
    #                                os.environ('PLAYER_STATS_ECH24_25'),
    #                                os.environ('PLAYER_STATS_NFD20_21'),
    #                                os.environ('PLAYER_STATS_NFD21_22'),
    #                                os.environ('PLAYER_STATS_NFD22_23'),
    #                                os.environ('PLAYER_STATS_NFD23_24'),
    #                                os.environ('PLAYER_STATS_NFD24_25')]

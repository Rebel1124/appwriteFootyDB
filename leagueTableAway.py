...
LEAGUE_TABLE_AWAY_collection_id = [os.getenv('LEAGUE_TABLE_AWAY_EPL24_25'), os.getenv('LEAGUE_TABLE_AWAY_PSL24_25')]
# LEAGUE_TABLE_AWAY_collection_id = [os.getenv('LEAGUE_TABLE_AWAY_EPL20_21'),
#                                os.getenv('LEAGUE_TABLE_AWAY_EPL21_22'),
#                                os.getenv('LEAGUE_TABLE_AWAY_EPL22_23'),
#                                os.getenv('LEAGUE_TABLE_AWAY_EPL23_24'),
#                                os.getenv('LEAGUE_TABLE_AWAY_EPL24_25'),
#                                os.getenv('LEAGUE_TABLE_AWAY_PSL20_21'),
#                                os.getenv('LEAGUE_TABLE_AWAY_PSL21_22'),
#                                os.getenv('LEAGUE_TABLE_AWAY_PSL22_23'),
#                                os.getenv('LEAGUE_TABLE_AWAY_PSL23_24'),
#                                os.getenv('LEAGUE_TABLE_AWAY_PSL24_25')]
    ...
    if leagueTable_data and 'data' in leagueTable_data:
        ...
        try:
            ...
            if (attList['total'] == 0):
                ...
                print('Initial Attributes added for '+ LEAGUE_TABLE_AWAY_collection_id[i])
            ...
            print('Check attributes for '+ str(LEAGUE_TABLE_AWAY_collection_id[i]))

...
def main(context):
    ...
    LEAGUE_TABLE_AWAY_collection_id = [os.environ['LEAGUE_TABLE_AWAY_EPL24_25'],
                                       os.environ['LEAGUE_TABLE_AWAY_PSL24_25'],
                                      os.environ['LEAGUE_TABLE_AWAY_ECH24_25'],
                                       os.environ['LEAGUE_TABLE_AWAY_NFD24_25']]
    # LEAGUE_TABLE_AWAY_collection_id = [os.environ['LEAGUE_TABLE_AWAY_EPL20_21'],
    #                                os.environ['LEAGUE_TABLE_AWAY_EPL21_22'],
    #                                os.environ['LEAGUE_TABLE_AWAY_EPL22_23'],
    #                                os.environ['LEAGUE_TABLE_AWAY_EPL23_24'],
    #                                os.environ['LEAGUE_TABLE_AWAY_EPL24_25'],
    #                                os.environ['LEAGUE_TABLE_AWAY_PSL20_21'],
    #                                os.environ['LEAGUE_TABLE_AWAY_PSL21_22'],
    #                                os.environ['LEAGUE_TABLE_AWAY_PSL22_23'],
    #                                os.environ['LEAGUE_TABLE_AWAY_PSL23_24'],
    #                                os.environ['LEAGUE_TABLE_AWAY_PSL24_25']]

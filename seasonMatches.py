...
seasonMatches_collection_id = [os.getenv('SEASON_MATCHES_EPL24_25'), os.getenv('SEASON_MATCHES_PSL24_25')]


# seasonMatches_collection_id = [os.getenv('SEASON_MATCHES_EPL20_21'),
#                                os.getenv('SEASON_MATCHES_EPL21_22'),
#                                os.getenv('SEASON_MATCHES_EPL22_23'),
#                                os.getenv('SEASON_MATCHES_EPL23_24'),
#                                os.getenv('SEASON_MATCHES_EPL24_25'),
    ...
    if leagueMatches_data and 'data' in leagueMatches_data:
        ...
        try:
            ...
            if (attList['total'] == 0):
                ...
                print('Initial Attributes added for '+ seasonMatches_collection_id[i])
            ...
            print('Check attributes for '+ str(seasonMatches_collection_id[i]))
            ...
            try:
                if(seasonMatch['id'] in docIDs):
                    ...
                    try:
                        ...
                        print('Documents created for '+seasonMatch['id'])
                    except Exception as e:
                        ...
                        if field_name and field_name in seasonMatch:
                            ...
                            print(f"{field_name} type: {type(seasonMatch[field_name])}")
                            print(f"{field_name} length: {len(str(seasonMatch[field_name]))}")
                            print(f"Preview: {str(seasonMatch[field_name])[:100]}...")
            except:
                print('Check document '+ str(seasonMatch['id']))

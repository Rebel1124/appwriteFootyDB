...
match_details_collection_id = os.getenv('MATCH_DETAILS_COLLECTION_ID')
...
if upcoming_matches and 'data' in upcoming_matches:
    ...
    try:
        ...
        if (attList['total'] == 0):
            ...
            print('Initial Attributes added for '+ match_details_collection_id)
        ...
        print('Check attributes for '+ str(matchID[i]))
        ...
        try:
            if(matchDetails['id'] in docIDs):
                ...
                try:
                    ...
                    print('Documents created for '+matchDetails['id'])
                except Exception as e:
                    ...
                    if field_name and field_name in matchDetails:
                        ...
                        print(f"{field_name} type: {type(matchDetails[field_name])}")
                        print(f"{field_name} length: {len(str(matchDetails[field_name]))}")
                        print(f"Preview: {str(matchDetails[field_name])[:100]}...")
        except:
            print('Check document '+ str(matchDetails['id']))

...
def main(context):
    ...
    teamsID=[1264,1265,1266,1269,1270,1273,1274,1278,1279,668342,676883,676886,676888,676891,685679,688962]
    ...
    lastx_collection_id = os.environ['LAST5_PSL24_25']
    ...
    for i in range(0,count):
        ...
        if lastX_data and 'data' in lastX_data:
            ...
            # except:
            #     context.log('Check attributes for '+ str(teamsID[i]))
